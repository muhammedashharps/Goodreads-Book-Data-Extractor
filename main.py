# Scrapping Book Data from GoodReads based on the ratings !
...
if __name__ == "__main__":
    ...
    try:
       url = input("Enter the exact link of the book list from  the goodreads website: ")
    except:
        print("Enter a Valid Link! ")

    while True:
          try:
            rating_threshold = float(input("Enter the minimum ratings you want to extract: "))
            break
          except ValueError:
